...
- the approved `Slice Mark` favicon/extension icon asset set now ships from `assets/icons/`, the manifest references the exported PNG sizes, and `index.html` points to the new favicon files
